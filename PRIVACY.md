...
Nobody, including the developer, has access to this data. If you delete the app, your data is deleted with it. If you want to back it up, you can use the manual "Export" feature in the app settings to save a file on your device.

## Analytics & Tracking

We do not use any analytics software, crash reporters, or tracking SDKs. We do not know how you use the app, which stores you visit, or where you live.
...
- Because it is sent to GitHub, this information becomes public and can be viewed by anyone.
- We do not collect your email or any hidden device identifiers during this process.
...
If you have questions about privacy, please open an issue on our [GitHub repository](https://github.com/Logarex/Atlas).
