...
- Tus fotos privadas
- Tus preferencias de la aplicación

Nadie, incluyendo el desarrollador, tiene acceso a estos datos. Si eliminas la aplicación, tus datos se eliminan con ella. Si deseas hacer una copia de seguridad, puedes usar la función manual de "Exportar" en la configuración de la aplicación para guardar un archivo en tu dispositivo.

## Analítica y Rastreo

No utilizamos ningún software de análisis, informes de errores ni SDKs de rastreo. No sabemos cómo usas la aplicación, qué tiendas visitas o dónde vives.
...
- Dado que se envía a GitHub, esta información se hace pública y puede ser vista por cualquier persona.
- No recopilamos tu correo electrónico ni ningún identificador oculto del dispositivo durante este proceso.
...
Si tienes preguntas sobre la privacidad, por favor abre un issue en nuestro [repositorio de GitHub](https://github.com/Logarex/Atlas).
