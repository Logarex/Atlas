...
- Ihre privaten Fotos
- Ihre App-Einstellungen

Niemand, auch nicht der Entwickler, hat Zugriff auf diese Daten. Wenn Sie die App löschen, werden Ihre Daten ebenfalls gelöscht. Wenn Sie sie sichern möchten, können Sie die manuelle "Export"-Funktion in den App-Einstellungen verwenden, um eine Datei auf Ihrem Gerät zu speichern.

## Analytik & Tracking

Wir verwenden keine Analysesoftware, Crash-Reporter oder Tracking-SDKs. Wir wissen nicht, wie Sie die App nutzen, welche Stores Sie besuchen oder wo Sie leben.
...
- Da sie an GitHub gesendet werden, werden diese Informationen öffentlich und können von jedem eingesehen werden.
- Wir erfassen bei diesem Vorgang nicht Ihre E-Mail-Adresse oder versteckte Gerätekennungen.
...
Wenn Sie Fragen zum Datenschutz haben, eröffnen Sie bitte ein Issue in unserem [GitHub-Repository](https://github.com/Logarex/Atlas).
